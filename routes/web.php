...
Route::any('bc', 'BcController@index')->name("bc.index");
Route::any('bc/av', 'BcController@indexWithAV')->name("bc.index-with-av");
Route::any('bc/test', 'BcController@indexTest')->name("bc.index-test");
